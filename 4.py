...
def draw_boat(screen, x, y, size, angle):
    ...
    pygame.draw.rect(boat_surface, (139, 69, 19), (50 * size, 60 * size, 100 * size, 20 * size))

    pygame.draw.line(boat_surface, (0, 0, 0), (100 * size, 60 * size), (100 * size, 10 * size), int(3 * size))

    pygame.draw.polygon(boat_surface, (255, 255, 255),
                        [(100 * size, 10 * size), (80 * size, 40 * size), (100 * size, 60 * size)])
...
def animate_boat():
    ...
    while running:
        ...
        pygame.draw.polygon(screen, (0, 105, 148), wave_points)
